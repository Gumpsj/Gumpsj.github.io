...
Code.TABS_ = ['blocks','python','arduino','xml'];
 ...
 */
Code.init = function() {
  // 1111111111111111111111111111111111111111修改1111111111111111111111111111111111111111
  // BUG: 出现原因是变量作用域不同，在单击时没有检测到相应的变量
  Code.loadInput = document.getElementById('loadXMLaction');
  Code.loadInput.addEventListener('change', Code.loadXML, false);
  /*document.getElementById('loadXMLfakeButton').onclick = function() {
    Code.loadInput.click();
  };*/
